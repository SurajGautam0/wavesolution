    ...
    const htmlContent = `
      <div style="font-family: 'Segoe UI', Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #f8fafc; border-radius: 12px; overflow: hidden;">
        <div style="background: linear-gradient(135deg, #1e3a5f 0%, #2d5a8e 100%); padding: 32px; text-align: center;">
          ...
          <p style="color: #93c5fd; margin: 8px 0 0; font-size: 14px;">WaveSolution — Gold Coast</p>
        </div>
        
        <div style="padding: 32px;">
          <h2 style="color: #1e293b; font-size: 18px; margin: 0 0 20px; border-bottom: 2px solid #e2e8f0; padding-bottom: 12px;">📋 Service Details</h2>
          <table style="width: 100%; border-collapse: collapse;">
            <tr>
              <td style="padding: 10px 0; color: #64748b; font-size: 14px; width: 140px;">Service Type</td>
              <td style="padding: 10px 0; color: #1e293b; font-size: 14px; font-weight: 600; text-transform: capitalize;">${service} Cleaning</td>
            </tr>
            <tr>
              <td style="padding: 10px 0; color: #64748b; font-size: 14px;">Property Size</td>
              <td style="padding: 10px 0; color: #1e293b; font-size: 14px; font-weight: 600;">${packageSize}</td>
            </tr>
            <tr>
              <td style="padding: 10px 0; color: #64748b; font-size: 14px;">Frequency</td>
              <td style="padding: 10px 0; color: #1e293b; font-size: 14px; font-weight: 600; text-transform: capitalize;">${frequency}</td>
            </tr>
            <tr>
              <td style="padding: 10px 0; color: #64748b; font-size: 14px;">Deep Clean Add-on</td>
              <td style="padding: 10px 0; color: #1e293b; font-size: 14px; font-weight: 600;">${includeDeepClean ? "✅ Yes" : "❌ No"}</td>
            </tr>
          </table>

          <h2 style="color: #1e293b; font-size: 18px; margin: 28px 0 20px; border-bottom: 2px solid #e2e8f0; padding-bottom: 12px;">👤 Customer Details</h2>
          <table style="width: 100%; border-collapse: collapse;">
            <tr>
            ...
            <tr>
              ...
              <td style="padding: 10px 0; color: #1e293b; font-size: 14px; font-weight: 600;"><a href="tel:${phone}" style="color: #2563eb; text-decoration: none;">${phone}</a></td>
            </tr>
            <tr>
              <td style="padding: 10px 0; color: #64748b; font-size: 14px;">Email</td>
              <td style="padding: 10px 0; color: #1e293b; font-size: 14px; font-weight: 600;"><a href="mailto:${email}" style="color: #2563eb; text-decoration: none;">${email}</a></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td style="padding: 10px 0; color: #1e293b; font-size: 14px; font-weight: 600;">${formattedDate}</td>
            </tr>
            ${notes ? `
            <tr>
              <td style="padding: 10px 0; color: #64748b; font-size: 14px; vertical-align: top;">Notes</td>
              <td style="padding: 10px 0; color: #1e293b; font-size: 14px; font-weight: 600;">${notes}</td>
            </tr>
            ` : ""}
          </table>
        </div>
        ...
        <div style="background: #f1f5f9; padding: 20px 32px; text-align: center; border-top: 1px solid #e2e8f0;">
          <p style="color: #94a3b8; font-size: 12px; margin: 0;">This booking was submitted via wavesolution.com.au</p>
        </div>
      </div>
    `
      ...
      <div style="font-family: 'Segoe UI', Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #f8fafc; border-radius: 12px; overflow: hidden;">
        ...
        <div style="padding: 32px;">
          ...
          <div style="background: #ffffff; border: 1px solid #e2e8f0; border-radius: 8px; padding: 20px; margin: 20px 0;">
            <h2 style="color: #1e293b; font-size: 16px; margin: 0 0 16px;">Your Booking Summary</h2>
            <table style="width: 100%; border-collapse: collapse;">
              <tr>
                <td style="padding: 8px 0; color: #64748b; font-size: 14px;">Service</td>
                <td style="padding: 8px 0; color: #1e293b; font-size: 14px; font-weight: 600; text-transform: capitalize;">${service} Cleaning</td>
              </tr>
              <tr>
                <td style="padding: 8px 0; color: #64748b; font-size: 14px;">Property Size</td>
                <td style="padding: 8px 0; color: #1e293b; font-size: 14px; font-weight: 600;">${packageSize}</td>
              </tr>
              <tr>
                <td style="padding: 8px 0; color: #64748b; font-size: 14px;">Frequency</td>
                <td style="padding: 8px 0; color: #1e293b; font-size: 14px; font-weight: 600; text-transform: capitalize;">${frequency}</td>
              </tr>
              <tr>
        ...
        <div style="background: #f1f5f9; padding: 20px 32px; text-align: center; border-top: 1px solid #e2e8f0;">
          <p style="color: #94a3b8; font-size: 12px; margin: 0;">WaveSolution — Professional Cleaning Services, Gold Coast</p>
          <p style="color: #94a3b8; font-size: 12px; margin: 4px 0 0;"><a href="https://wavesolution.com.au" style="color: #2563eb;">wavesolution.com.au</a></p>
        </div>
      </div>
    `
